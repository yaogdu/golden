...
<head>
	...
	<link href="${static_ctx}/static/css/teacher/singleManagement.css" rel="stylesheet" type="text/css" media="all"/>
	<script src="${static_ctx}/static/js/teacher/singleManagement.js" type="text/javascript"></script>
	<title>分类管理</title>
</head>
<body>
	<!-- 头部 -->
	...
	<script type="text/javascript" src="${static_ctx}/static/js/quiz/quiz-pending.js"></script>
</body>
</html>
