...
<body>
										...
										<div class="nataHead nataHead01">
			                            	<div class="mainTabWrap" style="border:0;padding:0;">
			                              		<ul class="mainTab" style="float:none;">
					                                <li style="line-height:normal;"><a data-id=2 href="${ctx }/teacher/resource/createCourseware"><span>课件</span></a></li>
					                                ...
					                                <li style="line-height:normal;" class="current"><a data-id=3 href="${ctx }/teacher/resource/createTestPaper"><span>试卷</span></a></li>
				                              	</ul>
	...
	<script type="text/javascript" src="${static_ctx}/static/js/teacher/resource/add/paper.js"></script>
