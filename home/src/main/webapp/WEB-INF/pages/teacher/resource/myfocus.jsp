...
<body>
						...
						<div class="mainBoxCon">
							...
							<div class="mainBox">
								<div class="mainCutBox">
									...
									<div class="mainHead">
										<ul class="mainTitle">
										 	<li ><a href="${ctx }/teacher/resource/myresource" >我上传的资源</a></li>
						                    <li><a data-id="2" href="javascript:void(0);" >我的收藏</a></li>
						                    <li><a data-id="3" href="javascript:void(0);" >我的下载</a></li>
						                  <!--   <li><a data-id="1" href="javascript:void(0);" >我的引用</a></li> -->
										</ul>
									</div>
								</div>
								<div class="mainIndex">
											...
											<div class="conNataWrap">
												...
												<div class="conNata">
													<div class="nataSelect">
														<div class="nataList">
															<div class="ListBox">
																<dl id="resourcetype" class="ListLine">
																	<dt>类型：</dt> 
																	<dd id=0 class="current">课件</dd>
																	<dd id=2>素材</dd>
																	<dd id=1>教学资料</dd>
																	<dd>题目</dd>
																	
																</dl>
																<dl id="resource_format" class="ListLine">
																	<dt>格式：</dt> 
																</dl>
															</div>
														</div>
	...
	{@each list as resource}
		 <tr>
			...
			<td><em class="ico-?{resource.resourceFormat} res-mag-ico"></em><a data-id=?{resource.id}  data-type=?{resource.objectType}  class="infoLabel">?{resource.resourceName}</a></td>
	...
	<script type="text/javascript" src="${static_ctx}/static/js/teacher/resource/myfocus.js"></script>
