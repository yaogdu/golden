	...
	<div class="preview-container"> 
		...
		<div id="description" class="formCon formCon01" style="display:none;" >
			...
			<div class="formList">
				<label>试卷类型：</label>
				<div class="info">
					<span class="infoLabel">??{paperType|getPaperType}</span>
				</div>
			</div>
			...
			<div class="formList">
				<label>试卷年份：</label>
				<div class="info">
					<span class="infoLabel">??{paperYear|formatText}</span>
				</div>
			</div>
			...
			<div id="stage_name" class="formList">
			 ...
			 <div class="formList">
				<label>考区：</label>
				<div class="info">
					<span class="infoLabel">?{testArea|areaCode} </span>
				</div>
			</div>
			{@if testArea==6}
			 <div id="testAreaSpan" class="formList">
				<label>地区：</label>
				<div class="info">
					<span  class="infoLabel"></span>
				</div>
			...
			<div class="formList">
				<label>年级：</label>
				<div class="info">
					<span class="infoLabel">?{grade|gradeCode} </span>
				</div>
			</div>
			<div class="formList">
				<label>学期：</label>
				<div class="info">
					<span class="infoLabel">?{term|termCode} </span>
				</div>
			</div>
			<div class="formList">
				<label>来源：</label>
...
<script type="text/javascript"
	src="${static_ctx}/static/js/preview/jwplayer.js"></script>
<script type="text/javascript"
	src="${static_ctx}/static/js/preview/swfobject.js"></script>
<script type="text/javascript" src="${static_ctx}/static/js/teacher/resource/review/reviewTestPaper.js"></script>
