...
<body>
									...
									<div class="mainConWrap" style="float:none;margin:0;">
										<div class="nataHead nataHead01">
			                            	...
			                            	<ul class="mainTab" style="float:none;">
					                                ...
					                                <li style="line-height:normal;"  class="current"><a data-id=-1 href="${ctx }/teacher/resource/createClip"><span>素材</span></a></li>
					                                <li style="line-height:normal;"><a data-id=3 href="${ctx }/teacher/resource/createTestPaper"><span>试卷</span></a></li>
				                              	</ul>
			                              		 
				                              	<div class="conFormWrap">
					                              	<div class="formCon">
										                <div id="clip_file" class="formList">
									            		...
									            		<div id="clip_format" class="formList">
														...
														<div id="clip_sharelevel" class="formList">
														...
														<div id="hidden">
														<!-- <div id="clip_phase" class="formList">
														...
														<div id="clip_selector1" class="formList">
															...
															<label>主题：</label>
															 <div class="info">
																<div class="infoAdd">
																  ...
																  <div class="BtnWrap">
																	<span class="btn-blue22" onclick="latte.teacher.clip.linkTopic($('#zhuti_topic'),$('#zhuti_selected'));"><a class="btnSave">添加</a></span>
																  	<span class="btn-blue22 margin-top5" onclick="latte.teacher.clip.unlinkTopic($('#zhuti_topic'),$('#zhuti_selected'));"><a class="btnSave">删除</a></span>
																  </div>
												...
												<div class="conBtnWrap">
													 <span id="btn_save_clip" class="BtnBlue24" ><a class="btnSave">提交信息</a></span>
												</div>
				                            </div>
		                          		</div>
									</div>
	...
	<script type="text/template" id="theme-selector-tpl">
		<div>
			...
			<div style="display:inline-block;width:50px;">
				<button class="btn-yellow" style="width:50px;height:25px;padding:0;" onclick="latte.teacher.clip.linkTopic($('#zhuti_topic'),$('#zhuti_selected'));">添加&gt;&gt;</button>
				<br><br>
				<button class="btn-yellow" style="width:50px;height:25px;padding:0;" onclick="latte.teacher.clip.unlinkTopic($('#zhuti_topic'),$('#zhuti_selected'));">&lt;&lt;删除</button>
			</div>
			<div style="display:inline-block;">
	...
	<script type="text/javascript" src="${static_ctx}/static/js/teacher/resource/add/clip.js"></script>
