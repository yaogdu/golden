	...
	<div class="preview-container"> 
		<div>
			<div class="formTab" style="margin-top:0;">
				...
				<div class="BtnWrap operBtn" style="margin-top:15px;">
					...
					{@else}
						<span id="btnFav" data-id=?{id} class="BtnWhite24">
		...
		<div id="description" class="formCon formCon01" style="display:none;" >
			...
			<div class="formList">
				<label>提交时间：</label>
				<div class="info">
					<span class="infoLabel">??{submitTime|timeFormat}</span>
				</div>
			</div>
			<div class="formList">
				<label>审核状态：</label>
...
<script type="text/javascript" src="${static_ctx}/static/js/teacher/resource/review/reviewCourseware.js"></script>
