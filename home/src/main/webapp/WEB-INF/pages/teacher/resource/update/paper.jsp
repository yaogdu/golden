...
<body><input type="hidden" id="id" name="" value="${id }" >
	<div class="container">
		<div class="wrapper">
			<!-- 头部 -->
				...
				<div class="mainBgCl">
					<div class="mainBgCr">
						<div class="mainBoxCon">
										...
										<div class="nataHead nataHead01">
			                            	<div class="mainTabWrap" style="border:0;padding:0;">
			                              		<ul class="mainTab" style="float:none;">
					                                ...
					                                <li style="line-height:normal;"><a data-id=0 href="javascript:void(0)"><span>教学资料</span></a></li>
					                                <li style="line-height:normal;"><a data-id=1 href="javascript:void(0)">素材</a></li>
					                                <li style="line-height:normal;"  class="current"><a data-id=3 href="javascript:void(0)"><span>试卷</span></a></li>
				                              	</ul>
				                              	<div class="conFormWrap">
					                              	<div class="formCon">
										                <div id="paper_file" class="formList">
														...
														<div id="paper_sharelevel" class="formList">
														...
														<div id="paper_selector1" class="formList">
															...
															<div id="paper_type" class="formList">
								<label><em>*</em>试卷类型：</label>
								<div class="info">
									<select id="paperType" name="paperType" class="infoSelect">
										 <option value="-1">请选择</option>
									</select>
								</div>
							</div>
														 <div id="paper_year" class="formList">
								<label><em>*</em>年份：</label>
								<div class="info">
									<select id="paperYear" name="paperYear" class="infoSelect">
							...
							<div id="paper_region" class="formList">
								<label><em>*</em>考区：</label>
								<div class="info">
									<select id="testArea" name="testArea" class="infoSelect">
			                           <option value="-1">请选择</option>
			                        </select>
								</div>
							</div>
								...
								<div class="info">
									<select id="provSel" name="provSel" class="infoSelect">
									<option value="-1">省</option>
									</select>
								</div>
								<div class="info">
									<select id="paperArea" name="paperArea" class="infoSelect">
									<option value="-1">市</option>
									</select>
								</div>
							</div>
							<div id="paper_grade" class="formList">
								<label><em>*</em>年级：</label>
								<div id="gradediv" class="info">
									<select id="grade" name="grade" class="infoSelect">
			                           <option value="-1">请选择</option>
			                        </select>
								</div>
							</div>
							<div id="paper_term" class="formList">
								<label><em>*</em>学期：</label>
								<div id="termdiv" class="info">
									<select id="term" name="term" class="infoSelect">
			                           <option value="-1">请选择</option>
			                        </select>
								</div>
							</div>
												...
												<div class="conBtnWrap">
													 <span id="btn_save_paper" class="BtnBlue24" ><a class="btnSave">提交信息</a></span>
												</div>
				                            </div>
		                          		</div>
									</div>
	...
	<script type="text/template" id="theme-selector-tpl">
		<div>
			...
			<div style="display:inline-block;width:50px;">
				<button class="btn-yellow" style="width:50px;height:25px;padding:0;" onclick="latte.teacher.paper.linkTopic($('#zhuti_topic'),$('#zhuti_selected'));">添加&gt;&gt;</button>
				<br><br>
				<button class="btn-yellow" style="width:50px;height:25px;padding:0;" onclick="latte.teacher.paper.unlinkTopic($('#zhuti_topic'),$('#zhuti_selected'));">&lt;&lt;删除</button>
			</div>
			<div style="display:inline-block;">
	...
	<script type="text/javascript" src="${static_ctx}/static/js/teacher/resource/update/paper.js"></script>
	<script type="text/javascript">
		$(document).ready(function() {
			latte.teacher.paper.init();
		});
	</script>
</body>
</html>
