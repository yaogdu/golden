...
<head>
	...
	<title>分类管理</title>
	<script src="${static_ctx}/static/js/teacher/updateResourceManagementPopUp.js" type="text/javascript"></script>
</head>
<body>
                  						...
                  						<table class="listTable">
	                    					...
	                    					<tbody id="tb">
											    ...
											    <c:forEach var="item" items="${items }" varStatus="sta">
											    	<tr id="parent_${sta.index + 1 }">
													    <td>
													    	<input id="ct_id_${sta.index + 1 }" type="hidden" value="${item.id }"/>
													    	<input type="text" class="infoText" maxlength="30" id="parent_input_${sta.index + 1 }" value="${item.name }"/>
													    </td>
													    <td><a class="first" href="javascript:void(0);" id="parent_up_${sta.index + 1 }"></a></td>
														<td><a class="down" href="javascript:void(0);" id="parent_down_${sta.index + 1 }"></a></td>
														<td><a class="del" href="javascript:void(0);" id="parent_delete_${sta.index + 1 }"></a></td>
												    </tr>
												</c:forEach>
											    <tr>
											      	<td rowspan="4">
